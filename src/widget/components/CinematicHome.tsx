  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-obsidian" role="dialog" aria-label={`Contact ${name}`}>
      ...
      <button
        ...
        className="absolute left-3 top-3 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-black/45 text-white backdrop-blur transition-colors hover:bg-black/60"
      >
      ...
      {/* Bottom content: headline, status, primary + secondary actions, footer. */}
      <div className="absolute inset-x-0 bottom-0 z-10 px-4 pb-3 pt-16">
        ...
        <div className="mt-3 text-center text-[11px] font-medium text-white/55">

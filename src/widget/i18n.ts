...
const ES: Record<string, string> = {
  ...
  // Case-type opener chips are localised by the backend now — /widget/config
  // returns the label already in the requested language (CI pins chat == FC), so
  // the FE renders it verbatim and needs no per-label map here.
};
